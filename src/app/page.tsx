  ...
  return (
    <main className='relative overflow-hidden'>
      <div className='max-w-7xl inset-0 m-auto pl-5 pr-5'>
        ...
        {/* <h1 className='text-3xl text-center pt-10'>Front end developer</h1>
        <p className='text-xl text-center pt-32'>공부 내용을 정리하는 블로그입니다.</p> */}
